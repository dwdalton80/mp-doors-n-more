...
const categories = [
  ...
  },
  {
    ...
    image: WINDOWS_IMAGE,
    description:
      "Our windows are designed for the Texas climate — energy-efficient, durable, and beautiful. We carry double-hung, casement, sliding, and picture windows in a variety of sizes and styles to fit any home.",
    features: [
      "Double-hung windows",
  ...
  },
  {
    ...
    subtitle: "Luxury Vinyl Plank & Tile",
    image: FLOORING_IMAGE,
    description:
      "Transform your home with luxury vinyl flooring that looks and feels like real hardwood or stone — at a fraction of the cost. Waterproof, scratch-resistant, and easy to install, our vinyl flooring is perfect for any room.",
    features: [
