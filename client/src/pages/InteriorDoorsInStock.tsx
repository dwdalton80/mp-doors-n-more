          ...
          <div className="relative max-w-2xl w-full bg-white rounded-lg" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
              ...
              <div className="flex flex-col items-center justify-center gap-4">
                <img src={showSecondImage ? selectedProduct.imageUrl2 : selectedProduct.imageUrl} alt={selectedProduct.title} className="w-full h-auto rounded-lg object-cover" style={{maxHeight: '400px'}} />
